...
```mermaid
flowchart TD
    A["Level 0 불완전 Incomplete"] --> B["Level 1 수행 Performed"]
    B --> C["Level 2 관리 Managed"]
    C --> D["Level 3 확립 Established"]
    D --> E["Level 4 예측 Predictable"]
    E --> F["Level 5 최적화 Optimizing"]
```
